...
public class Logic
    ...
    public static double rightTrianglePerimeter(double base, double height) {
        double mhipotenus = Math.sqrt(Math.pow(base, 2) + Math.pow(height, 2));
        double cevre = mhipotenus + base + height;
        return cevre;
    }

    public static double rectangleArea(double length, double width) {
        double raarea = length * width;

        return raarea;
    }

    public static double rectanglePerimeter(double length, double width) {
        double raperimeter = 2 * (length + width);
    ...
    public static double boxSurfaceArea(double length, double width,
                                        double depth) {
        double sarea = 2 * length * width + 2 * length * depth + 2 * width * depth;
        return sarea;
    }
    ...
    public static double sphereSurfaceArea(double radius) {
        double ssarea = 4 * Math.PI * Math.pow(radius, 2);
        return ssarea;
    }

    public static double circleCircumference(double radius) {
        double ccference = 2 * Math.PI * radius;
        return ccference;
    }
    ...
    public static double rightTriangleArea(double length, double width) {
        double rtarea = (1.0 / 2.0) * length * width;
